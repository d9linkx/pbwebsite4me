...
import { AccountResponse, Transaction } from "@/types/transaction";
import { apiService } from "@/utils/apiService";
import { ArrowDown, ArrowDownLeft, ArrowLeft, ArrowUpRight, Badge, CreditCard, Eye, EyeOff, Plus, TrendingUp, Wallet } from "lucide-react";
    ...
    const fetchWalletData = async () => {
      ...
      try {
        ...
        const accountResponse =
          await apiService.get<AccountResponse>("/account/");
          ...
          >
            ...
            <div className="relative">
              <div className="flex items-center justify-between mb-6">
                ...
                >
                  {showBalance ? (
                    <Eye size={18} className="text-gray-300/90" />
                  ) : (
                    <EyeOff size={18} className="text-gray-300/90" />
                  )}
                </motion.button>
              </div>
              ...
              <div className="mb-6">
                ...
                <div className="flex items-center space-x-2">
                  ...
                  <span className="text-gray-300/90 text-sm font-medium">
                    +{formatAmount(getTotalThisMonth())}
                  </span>
                  ...
                  .map((transaction, index) => (
                    <motion.div
                      ...
                      className={`p-4 hover:bg-gray-50 transition-colors ${
                        index !== walletData.transactions.slice(0, 5).length - 1
                        ...
                        <div className="flex items-center space-x-3">
                          ...
                          <div>
                            ...
                            <div className="flex items-center space-x-2 mt-1">
                              ...
                              <Badge
                                className={`text-xs px-2 py-0.5 rounded-lg border-0 ${
                                  transaction.status === "success"
              ...
              <div className="flex items-start space-x-3">
                ...
                <div className="flex-1">
                  <h3 className="font-semibold text-gray-900 mb-1">
                    Pal Earnings Insight
                  </h3>
                  <p className="text-sm text-gray-600 mb-2">
                    You&apos;ve earned {formatAmount(getTotalThisMonth())} this
                    month from{" "}
                    {
