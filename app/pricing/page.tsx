            ...
            <div className="space-y-6 mb-8">
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-3 rounded-lg text-background border border-gray-300 focus:border-primary focus:ring-2 focus:ring-primary-light outline-none"
                />
            ...
            >
              ...
              >
                ...
                <div className="space-y-3">
                  ...
                  <div className="border-t-2 border-gray-200 pt-3 flex justify-between">
                    <span className="font-bold text-dark">You Keep (80%):</span>
                    <span className="font-bold text-primary text-xl">
