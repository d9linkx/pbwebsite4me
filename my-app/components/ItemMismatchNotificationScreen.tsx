...
export function ItemMismatchNotificationScreen({
  ...
  if (!job || !user) {
    return (
      <div className="min-h-screen bg-white flex items-center justify-center">
        <p className="text-gray-500">Unable to load notification details</p>
      </div>
    );
  }
  ...
  return (
    <div className="min-h-screen bg-white flex flex-col">
      {/* Header */}
      <motion.div 
        className="bg-white border-b border-gray-200 shadow-sm p-6 sticky top-0 z-20 shadow-lg"
      ...
      >
        <div className="flex items-center space-x-4">
          ...
          <div>
            <h1 className="text-lg font-semibold text-gray-900">Item Mismatch Alert</h1>
            <p className="text-sm text-gray-500">Dispute in progress</p>
          </div>
        </div>
      </motion.div>
      ...
      <div className="flex-1 overflow-y-auto p-6 space-y-6 relative z-10">
        ...
        >
          <div className="flex items-start space-x-4">
            ...
            <div className="flex-1">
              <h3 className="text-gray-900 font-semibold mb-2">Item Mismatch Reported</h3>
        ...
        >
          <div className="flex items-center justify-between mb-2">
            <span className="text-gray-500 text-sm">Time Progress</span>
        ...
        >
          <h3 className="text-gray-900 font-semibold mb-4">Expected Item</h3>
          <div className="space-y-3">
            ...
            <div>
              ...
              <p className="text-gray-900">{job.description || 'N/A'}</p>
            </div>
            <div className="grid grid-cols-2 gap-3">
              <div>
                <p className="text-gray-500 text-sm">Size</p>
                <p className="text-gray-900">{job.itemSize || 'N/A'}</p>
              </div>
              <div>
                <p className="text-gray-500 text-sm">Category</p>
                <p className="text-gray-900">{job.category || 'N/A'}</p>
              </div>
            </div>
          </div>
        </motion.div>
        ...
        >
          <h3 className="text-gray-900 font-semibold mb-4">Pal Information</h3>
          <div className="flex items-center space-x-3 mb-4">
            <div className="w-12 h-12 rounded-full bg-gradient-to-br from-orange-500 to-red-500 flex items-center justify-center">
              <User size={24} className="text-gray-900" />
            </div>
            <div>
              <p className="text-gray-900 font-medium">{job.selectedPalName || 'N/A'}</p>
