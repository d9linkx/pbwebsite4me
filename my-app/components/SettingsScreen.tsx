...
import { ArrowLeft, User, Bell, Shield, CreditCard, HelpCircle, LogOut, ChevronRight, CheckCircle, TrendingUp, Users } from 'lucide-react';
    ...
    },
    {
      ...
      items: [
        { 
          ...
          badgeColor: user.activeEscrows?.length ? 'bg-green-100 text-green-700' : 'bg-blue-100 text-blue-700',
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <div className="relative z-10">
        ...
        <div className="p-6">
          <motion.div
            className="bg-gray-50 border border-gray-200 rounded-2xl p-5 cursor-pointer hover:bg-white transition-all duration-300"
          ...
          >
            <div className="flex items-center space-x-4">
              <div className="w-16 h-16 rounded-full bg-gradient-to-br from-[#f44708] to-[#ff5722] flex items-center justify-center shadow-sm">
              ...
              <div className="flex-1">
                <div className="flex items-center space-x-2">
                  <h3 className="text-gray-900 text-lg font-semibold">{user.name || 'User'}</h3>
                  {user.isVerified && (
        ...
        <div className="px-6 pb-6 space-y-6">
          {settingsSections.map((section, sectionIndex) => (
            ...
            >
              <h3 className="text-gray-900 mb-3 font-semibold text-sm uppercase tracking-wider">{section.title}</h3>
                ...
                {section.items.map((item, itemIndex) => {
                  ...
                  return (
                    <motion.div
                      ...
                      } ${item.action ? 'cursor-pointer hover:bg-white transition-colors' : ''}`}
                      onClick={item.action}
