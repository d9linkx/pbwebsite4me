      ...
      >
        <div className="flex items-center space-x-4">
          ...
          <div>
            ...
            <p className="text-sm text-gray-400">Earn by inviting friends</p>
          </div>
        </div>
      </motion.div>
      ...
      <div className="p-6 space-y-6 relative z-10">
        ...
        >
          ...
          <div className="grid grid-cols-2 gap-3">
            <motion.button
              onClick={handleCopy}
              className="bg-[#2f2f2f] hover:bg-[#1a1a1a] text-white rounded-xl py-3 px-4 font-medium transition-all duration-300 flex items-center justify-center space-x-2"
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.95 }}
            >
