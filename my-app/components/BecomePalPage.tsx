...
import { ArrowRight, Package, TrendingUp, Clock, Shield, DollarSign, MapPin, Check, Star, Users, Smartphone, Bike } from 'lucide-react';

interface BecomePalPageProps {
  onNavigate?: (screen: string) => void;
}

export function BecomePalPage({ onNavigate }: BecomePalPageProps) {
  ...
  const benefits = [
    {
      ...
      description: 'Set your own rates and keep 80% of every delivery. Top Pals earn over ₦200k monthly.',
      stat: '₦120k',
    ...
    },
    {
      ...
      description: 'Choose when, where, and how much you work. Perfect for students, freelancers, or anyone seeking extra income.',
      stat: '24/7',
    ...
    },
    {
      ...
      description: 'Get paid instantly after each delivery. Money hits your wallet immediately - withdraw anytime.',
      stat: 'Instant',
    ...
    },
    {
      ...
      description: 'All deliveries are insured. Your safety and security are our top priorities.',
      stat: '100%',
  ...
  const howItWorks = [
    {
      step: '1',
      title: 'Sign Up',
      description: 'Create your Pal account in under 5 minutes. Upload your ID and vehicle details.',
      time: '5 mins'
    },
    {
      step: '2',
      title: 'Get Verified',
      description: 'Quick background check and vehicle verification. Most Pals are approved within 24 hours.',
      time: '24 hours'
    },
    {
      step: '3',
      title: 'Browse Jobs',
      description: 'See available deliveries in your area. Choose jobs that match your schedule and route.',
      time: 'Instant'
    },
    {
      step: '4',
      title: 'Deliver & Earn',
      description: 'Pick up, deliver, and get paid. Rate senders and build your reputation.',
      time: '₦₦₦'
    }
  ];
  ...
  const testimonials = [
    {
      name: 'Chidi Okafor',
      role: 'Top Pal - Lagos',
      image: 'https://images.unsplash.com/photo-1614445084552-867ba96a456e?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxBZnJpY2FuJTIwbWFuJTIwcmlkaW5nJTIwbW90b3JjeWNsZSUyMHVyYmFufGVufDF8fHx8MTc2MDExNDE4Mnww&ixlib=rb-4.1.0&q=80&w=1080',
      rating: 4.9,
      quote: "I've been a Pal for 6 months and I'm making more than my previous job. The flexibility is amazing – I work around my classes and still earn ₦150k monthly.",
      earnings: '₦150,000/mo'
    },
    {
      name: 'Amina Ibrahim',
      role: 'Weekend Pal - Ibadan',
      image: 'https://images.unsplash.com/photo-1733246548418-3465c565bc9d?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxOaWdlcmlhbiUyMHlvdW5nJTIwcHJvZmVzc2lvbmFsJTIwc21hcnRwaG9uZXxlbnwxfHx8fDE3NjAxMTQxODJ8MA&ixlib=rb-4.1.0&q=80&w=1080',
      rating: 4.8,
      quote: "As a working mother, Prawnbox lets me earn extra income on weekends when my kids are with their dad. It's perfect for anyone who needs flexible side income.",
      earnings: '₦80,000/mo'
    },
    {
      name: 'Tunde Adeyemi',
      role: 'Full-Time Pal - Lagos',
      image: 'https://images.unsplash.com/photo-1655720357872-ce227e4164ba?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxBZnJpY2FuJTIwZW50cmVwcmVuZXVyJTIwc3VjY2Vzc2Z1bCUyMGJ1c2luZXNzfGVufDF8fHx8MTc2MDExNDE4Mnww&ixlib=rb-4.1.0&q=80&w=1080',
      rating: 5.0,
      quote: "I quit my 9-5 to become a full-time Pal and I've never looked back. I'm my own boss, earning more, and I love the freedom.",
      earnings: '₦220,000/mo'
    }
  ];
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center py-[0px] p-[0px] mx-[-20px] my-[0px] mr-[-15px] mb-[0px] ml-[-15px] mt-[-30px] lg:mt-[-13px] lg:ml-[-25px] lg:mr-[-25px]">
            <div className="pt-[80px] pr-[0px] pb-[0px] pl-[0px]">
              <div className="inline-flex items-center space-x-2 bg-[#f44708]/20 px-4 py-2 rounded-full mb-6">
                ...
                <span className="text-sm font-medium text-[#f44708]">Join 5,000+ Active Pals</span>
              </div>

              <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold mb-6 leading-tight">
                Become a <span className="text-[#f44708]">Pal</span>
              </h1>

              <p className="text-xl text-gray-300 mb-8 leading-relaxed">
                Turn your free time into income. Deliver packages, set your own schedule, and earn up to ₦200,000 monthly in Lagos and Ibadan.
              </p>

              {/* Quick Stats */}
              <div className="grid grid-cols-3 gap-4 mb-8">
                <div className="bg-white/10 backdrop-blur-sm rounded-xl p-4 text-center">
                  <div className="text-2xl font-bold text-[#f44708]">₦120k</div>
                  <div className="text-xs text-gray-300 mt-1">Avg. Monthly</div>
                </div>
                <div className="bg-white/10 backdrop-blur-sm rounded-xl p-4 text-center">
                  <div className="text-2xl font-bold text-[#f44708]">80%</div>
                  <div className="text-xs text-gray-300 mt-1">Your Earnings</div>
                </div>
                <div className="bg-white/10 backdrop-blur-sm rounded-xl p-4 text-center">
                  <div className="text-2xl font-bold text-[#f44708]">24/7</div>
              ...
              <p className="text-sm text-gray-400 mt-4">
                ✓ No registration fee  ✓ Get approved in 24 hours  ✓ Start earning immediately
              </p>
            </div>
                ...
                <div className="absolute bottom-6 left-6 right-6 bg-white rounded-xl p-4 shadow-xl">
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <div className="text-2xl font-bold text-[#2f2f2f]">₦12,500</div>
                    </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Join Nigeria&apos;s fastest-growing delivery platform and enjoy benefits that put you first.
            </p>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-12 text-center">
            <p className="text-gray-600 mb-6">
              ✓ No experience required  ✓ Free training provided  ✓ Start earning in 48 hours
            </p>
            <button
              onClick={handleGetStarted}
      ...
      <section className="py-20 bg-gradient-to-br from-[#2f2f2f] to-black text-white relative overflow-hidden">
        ...
        <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-gray-300 mb-8 max-w-2xl mx-auto">
            Join thousands of Pals already earning flexible income with Prawnbox. Sign up now and get approved in 24 hours.
          </p>
