    ...
    <div className="min-h-screen bg-white">
      ...
      >
        <motion.button
          ...
          className="w-full flex items-center justify-between bg-white hover:bg-gray-50 border border-gray-200 rounded-xl px-4 py-3 transition-all shadow-sm"
        ...
        >
          ...
          {showRouteFilter ? <ChevronUp size={18} className="text-gray-700" /> : <ChevronDown size={18} className="text-gray-700" />}
        </motion.button>
            ...
            >
              ...
              {(routeFilter || selectedState || itemWorthFilter || sizeFilter || categoryFilter) && (
                <motion.button
                  ...
                  className="w-full bg-white hover:bg-gray-50 border border-gray-300 text-gray-700 px-4 py-3 rounded-xl font-medium transition-all shadow-sm"
                  whileHover={{ scale: 1.02 }}
                  whileTap={{ scale: 0.98 }}
                >
                  Clear All Filters
      ...
      {/* Jobs List */}
      <div className="px-6 py-6 space-y-4 relative z-10 bg-white">
              ...
              <div className="p-6">
                ...
                <div className="bg-gradient-to-r from-blue-500/10 to-purple-500/10 border border-blue-500/20 rounded-xl p-4 mb-4">
                  <div className="flex items-center justify-between">
                    <div className="flex items-center space-x-3 flex-1">
                      ...
                      <div>
                        ...
                        <div className="text-sm text-gray-900 font-medium">{getJobRoute(job)}</div>
                      </div>
                    </div>
                    <div className="text-right">
                      <div className="text-xs text-gray-500">{routeEstimates.distance}</div>
                      <div className="text-xs text-gray-500">{routeEstimates.estimatedTime}</div>
                    </div>
                  </div>
                  ...
                  <motion.button
                    ...
                    className="w-full mt-3 flex items-center justify-center space-x-2 bg-white hover:bg-gray-50 border border-gray-200 rounded-xl py-2 text-xs text-gray-700 font-medium transition-all"
                    whileHover={{ scale: 1.02 }}
                    whileTap={{ scale: 0.98 }}
                  >
                    <Map size={14} />
                  ...
                  <div className="bg-gray-50 border border-gray-200 rounded-xl p-4">
                    <div className="flex items-center justify-between mb-3">
                      <div className="flex items-center space-x-2">
                        ...
                        <span className="text-gray-900 font-medium">Place Your Bid</span>
                      </div>
                    ...
                    <form onSubmit={(e) => handleBidSubmit(job, e)} className="space-y-3">
                      <Input
                        ...
                        className="bg-white border-gray-300 text-gray-900 placeholder:text-gray-500 rounded-xl h-12"
                        min="100"
                        required
                      />
                        ...
                        <div className="flex items-center justify-between">
                          ...
                          {getBidStatusMessage(job).canEdit && (
                            <motion.button
                              ...
                              className="flex items-center space-x-2 bg-white hover:bg-gray-50 border border-gray-200 text-gray-700 px-4 py-2 rounded-xl text-sm font-medium transition-all"
                              whileHover={{ scale: 1.05 }}
                              whileTap={{ scale: 0.95 }}
                            >
                              <Edit3 size={14} />
                        ...
                        <form onSubmit={(e) => handleEditBid(job, e)} className="space-y-3">
                          ...
                          <div className="flex space-x-2">
                            <motion.button
                              ...
                              className="flex-1 bg-white hover:bg-gray-50 border border-gray-200 text-gray-700 rounded-xl py-3 font-medium transition-all"
                              whileHover={{ scale: 1.02 }}
                              whileTap={{ scale: 0.98 }}
                            >
                              Cancel
                ...
                <motion.button
                  ...
                  className="w-full mt-4 flex items-center justify-between bg-gray-50 hover:bg-gray-100 border border-gray-200 rounded-xl px-4 py-3 transition-all"
                  whileHover={{ scale: 1.01 }}
                  whileTap={{ scale: 0.99 }}
                >
                  ...
                  {isExpanded ? <ChevronUp size={18} className="text-gray-700" /> : <ChevronDown size={18} className="text-gray-700" />}
                </motion.button>
                ...
                <AnimatePresence>
                  {isExpanded && (
                    ...
                    >
                      {/* Full Addresses */}
                      <div className="bg-gray-50 border border-gray-200 rounded-xl p-4">
                        <h4 className="text-gray-900 font-medium mb-3">Full Addresses</h4>
                        <div className="space-y-3">
                          <div>
                            <div className="text-xs text-gray-500 mb-1">Pickup</div>
                            <p className="text-gray-900 text-sm">{job.pickupLocation}</p>
                          </div>
                          <div>
                            <div className="text-xs text-gray-500 mb-1">Dropoff</div>
                            <p className="text-gray-900 text-sm">{job.dropoffLocation}</p>
                          </div>
                        </div>
                      </div>
                      ...
                      {/* Package Details */}
                      <div className="bg-gray-50 border border-gray-200 rounded-xl p-4">
                        <h4 className="text-gray-900 font-medium mb-3">Package Details</h4>
                        <div className="grid grid-cols-2 gap-3">
                          ...
                          <div>
                            ...
                            <p className="text-gray-900 text-sm">{job.weight}</p>
                          </div>
                        </div>
                      </div>
                      ...
                      {job.images && job.images.length > 0 && (
                        <div className="bg-gray-50 border border-gray-200 rounded-xl p-4">
                          <h4 className="text-gray-900 font-medium mb-3">Item Photos</h4>
                          <div className="grid grid-cols-2 gap-3">
                      ...
                      {job.notes && (
                        <div className="bg-gray-50 border border-gray-200 rounded-xl p-4">
                          <h4 className="text-gray-900 font-medium mb-3">Special Instructions</h4>
