      ...
      >
        <div className="flex items-center justify-between">
          <div className="flex items-center space-x-4">
            ...
            <h1 className="text-xl text-white">Profile Information</h1>
          </div>
          {!isEditing && (
            <motion.button
              onClick={() => setIsEditing(true)}
              className="bg-white/10 border border-white/20 text-white hover:bg-white/20 rounded-xl px-4 py-2 transition-all duration-300"
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.95 }}
            >
              Edit
      ...
      <div className="flex-1 overflow-y-auto px-6 pb-32 relative z-10">
        <div className="space-y-4">
          ...
          <motion.div
            ...
            transition={{ delay: 0.2 }}
          >
            <h3 className="text-white mb-4 flex items-center font-semibold">
              ...
              <div>
                ...
                <div className="relative">
                  <Input
                    ...
                    className="mt-1 rounded-xl h-12 bg-white/5 border-white/20 text-white placeholder:text-gray-500 pl-10 disabled:opacity-50"
                    disabled={!isEditing}
                    required
                  />
                  <Mail size={16} className="absolute left-3 top-1/2 transform -translate-y-1/2 text-gray-400 mt-0.5" />
                </div>
              </div>
              ...
              <div>
                ...
                <div className="relative">
                  <Input
                    ...
                    disabled={!isEditing}
                  />
                  <Phone size={16} className="absolute left-3 top-1/2 transform -translate-y-1/2 text-gray-400 mt-0.5" />
                </div>
              </div>
            </div>
          </motion.div>
          ...
          >
            ...
            <div>
              ...
              <Textarea
                ...
                className="mt-1 rounded-xl bg-white/5 border-white/20 text-white placeholder:text-gray-500 min-h-20 disabled:opacity-50"
                disabled={!isEditing}
              />
