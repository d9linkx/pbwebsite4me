...
import { Bell, Menu, X, Zap, Package } from 'lucide-react';
import { motion } from 'framer-motion';
import { UserRole, Screen, User, Notification } from '../../types';
import { ROLE_PRIORITIES } from '../../constants/dashboard';
import prawnboxLogo from 'figma:asset/b611c0bb8720e24f5f3f3e3244326d8814bc6df1.png';
...
export function DashboardHeader({
  ...
  return (
    <>
      ...
      {/* Role Switcher */}
      {(currentScreen === 'dashboard' || currentScreen === 'notifications') && (
        <motion.div
          className="bg-[#2f2f2f] shadow-sm p-4 lg:p-6 w-full border-b border-white/10"
