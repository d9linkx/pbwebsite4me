      ...
      >
        <div className="flex items-center space-x-4">
          ...
          <div>
            ...
            <p className="text-sm text-gray-400">Transfer to your bank account</p>
          </div>
        </div>
      </motion.div>
      ...
      <div className="flex-1 overflow-y-auto p-6 space-y-6 relative z-10">
        ...
        >
          ...
          <Input
            ...
            className="bg-white/10 border-white/20 text-white text-2xl font-bold placeholder-gray-500 focus:border-green-500 mb-2"
          />
          ...
          <div className="grid grid-cols-3 gap-2 mt-4">
            {[5000, 10000, 20000].map((preset) => (
              <motion.button
                ...
                className="py-2 rounded-xl bg-white/10 hover:bg-white/20 border border-white/20 text-white text-sm disabled:opacity-30"
                whileHover={{ scale: 1.05 }}
                whileTap={{ scale: 0.95 }}
              >
                {formatAmount(preset)}
        ...
        >
          ...
          <div>
            <label className="text-sm text-gray-400 mb-2 block">Bank</label>
          ...
          >
            ...
            <div className="space-y-3">
              <div className="flex items-center justify-between">
                ...
                <span className="text-white">{formatAmount(withdrawAmount)}</span>
              </div>
              <div className="flex items-center justify-between">
              ...
              <div className="flex items-center justify-between">
                ...
                <span className="text-2xl font-bold text-green-400">{formatAmount(amountToReceive)}</span>
              </div>
            </div>
          </motion.div>
        )}
