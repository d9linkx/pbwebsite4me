...
interface SendItemsPageProps {
  onNavigate?: (screen: string) => void;
}

export function SendItemsPage({ onNavigate }: SendItemsPageProps) {
  ...
  const benefits = [
    {
      ...
      title: 'Save Up to 60%',
      description: 'Pay less than traditional couriers. Flexible bidding means you choose the price that works for you.',
      stat: '60%',
    ...
    },
    {
      ...
      description: 'Get your items delivered within hours. No waiting days for packages to arrive.',
      stat: '2-4 hrs',
    ...
    },
    {
      ...
      description: 'Your payment is secured in escrow until delivery is complete. 100% safe and guaranteed.',
      stat: '100%',
    ...
    },
    {
      ...
      description: 'Track your package live on a map. Chat with your Pal anytime. Complete transparency.',
      stat: 'Live',
  ...
  const howItWorks = [
    {
      ...
      description: 'Tell us what you\'re sending, where it\'s going, and when you need it delivered. Takes 2 minutes.',
      time: '2 mins'
    },
    {
      step: '2',
      title: 'Get Bids from Pals',
      description: 'Verified Pals bid on your delivery. Choose based on price, rating, and delivery time.',
      time: '5-15 mins'
    },
    {
      step: '3',
      title: 'Make Secure Payment',
      description: 'Pay via wallet, card, or bank transfer. Money held safely in escrow until delivery.',
      time: 'Instant'
    },
    {
      step: '4',
      title: 'Track & Receive',
      description: 'Track your package live. Your Pal delivers, you confirm, payment releases automatically.',
      time: 'Real-time'
    }
  ];
  ...
  const testimonials = [
    {
      ...
      image: 'https://images.unsplash.com/photo-1758525223894-67f450ee0825?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxBZnJpY2FuJTIwd29tYW4lMjBvbmxpbmUlMjBzaG9wcGluZyUyMHBhY2thZ2V8ZW58MXx8fHwxNzYwMTE0Mzk3fDA&ixlib=rb-4.1.0&q=80&w=1080',
      rating: 5.0,
      quote: "I use Prawnbox daily to deliver clothes to my customers. The bidding system means I always get the best price, and my clients love the same-day delivery!",
      savings: 'Saves ₦50,000/month'
    },
    {
      name: 'Mr. Femi Adeyemi',
      role: 'Entrepreneur - Ibadan',
      image: 'https://images.unsplash.com/photo-1679117349740-c46c819d0373?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxBZnJpY2FuJTIwYnVzaW5lc3MlMjBwZXJzb24lMjBtb2JpbGUlMjBwaG9uZXxlbnwxfHx8fDE3NjAxMTQzOTh8MA&ixlib=rb-4.1.0&q=80&w=1080',
      rating: 4.9,
      quote: "Prawnbox has been a game-changer for my business. I can send documents and products anywhere in the city within hours. The escrow system gives me peace of mind.",
      savings: 'Uses 5x weekly'
    },
    {
      name: 'Grace Okafor',
      role: 'Student - Lagos',
      image: 'https://images.unsplash.com/photo-1682773083899-0948e4e7d8d3?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxOaWdlcmlhbiUyMHByb2Zlc3Npb25hbCUyMHNtYXJ0cGhvbmUlMjBkZWxpdmVyeXxlbnwxfHx8fDE3NjAxMTQzOTd8MA&ixlib=rb-4.1.0&q=80&w=1080',
      rating: 5.0,
      quote: "As a student, Prawnbox helps me send gifts home to my family without breaking the bank. The prices are unbeatable and tracking is so easy!",
      savings: 'Saves 65%'
    }
  ];

  const features = [
    { icon: <Check className="w-5 h-5" />, text: 'No Platform Fees for Senders' },
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center py-[0px] p-[0px] mx-[-20px] my-[0px] mr-[-15px] mb-[0px] ml-[-15px] mt-[-30px] lg:mt-[-13px] lg:ml-[-25px] lg:mr-[-25px]">
            <div className="pt-[50px] pr-[0px] pb-[0px] pl-[0px]">
              <div className="inline-flex items-center space-x-2 bg-[#f44708]/20 px-4 py-2 rounded-full mb-6">
                ...
                <span className="text-sm font-medium text-[#f44708]">50,000+ Deliveries Completed</span>
              </div>
              ...
              <p className="text-xl text-gray-300 mb-8 leading-relaxed">
                Nigeria&apos;s smartest way to send packages. Same-day delivery, save up to 60%, and track everything live. From ₦1,000 per delivery.
              </p>

              {/* Quick Stats */}
              <div className="grid grid-cols-3 gap-4 mb-8">
                <div className="bg-white/10 backdrop-blur-sm rounded-xl p-4 text-center">
                  <div className="text-2xl font-bold text-[#f44708]">₦1,000</div>
                  <div className="text-xs text-gray-300 mt-1">From</div>
                </div>
                <div className="bg-white/10 backdrop-blur-sm rounded-xl p-4 text-center">
                  <div className="text-2xl font-bold text-[#f44708]">2-4hrs</div>
                  <div className="text-xs text-gray-300 mt-1">Delivery Time</div>
                </div>
                <div className="bg-white/10 backdrop-blur-sm rounded-xl p-4 text-center">
                ...
                <div className="absolute bottom-6 left-6 right-6 bg-white rounded-xl p-4 shadow-xl">
                  <div className="flex items-center justify-between">
                    <div className="flex-1">
                      <div className="text-sm text-gray-600 mb-1">Active Delivery</div>
                      <div className="text-lg font-bold text-[#2f2f2f]">Wedding Dress Package</div>
                      <div className="text-xs text-gray-500 mt-1">Arriving in 15 minutes</div>
                    </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              The smartest, safest, and most affordable way to send packages in Nigeria
            </p>
          </div>
          ...
          <div className="mt-12 bg-white rounded-2xl p-8 shadow-lg">
            <h3 className="text-2xl font-bold text-[#2f2f2f] mb-6 text-center">Everything You Need</h3>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {useCases.map((useCase, index) => (
              ...
              >
                ...
                <h3 className="text-xl font-bold text-[#2f2f2f] mb-2">{useCase.title}</h3>
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="bg-white rounded-2xl shadow-xl overflow-hidden">
            <div className="grid grid-cols-1 md:grid-cols-2 divide-y md:divide-y-0 md:divide-x divide-gray-200">
              {/* Traditional Courier */}
              <div className="p-8">
                <h3 className="text-xl font-bold text-gray-400 mb-6 text-center">Traditional Courier</h3>
                <div className="space-y-4">
                  <div className="flex items-center justify-between">
                    <span className="text-gray-600">Delivery Fee</span>
                    <span className="font-bold text-gray-900">₦4,000 - ₦15,000</span>
                  </div>
                  <div className="flex items-center justify-between">
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <span className="font-bold text-gray-900">Extra ₦2,000+</span>
                  </div>
                  <div className="flex items-center justify-between">
                    <span className="text-gray-600">Tracking</span>
                    <span className="font-bold text-gray-900">Premium only</span>
                  </div>
                  <div className="pt-4 border-t">
                    <div className="text-center">
                      <div className="text-3xl font-bold text-gray-900">₦6,000+</div>
              ...
              <div className="p-8 bg-gradient-to-br from-[#f44708]/5 to-orange-50">
                <h3 className="text-xl font-bold text-[#f44708] mb-6 text-center">Prawnbox</h3>
                <div className="space-y-4">
                  <div className="flex items-center justify-between">
                    <span className="text-gray-700">Delivery Fee</span>
                    <span className="font-bold text-[#2f2f2f]">From ₦1,000</span>
                  </div>
                  <div className="flex items-center justify-between">
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <span className="font-bold text-green-600">Free Live GPS</span>
                  </div>
                  <div className="pt-4 border-t border-[#f44708]/20">
                    <div className="text-center">
                      <div className="text-3xl font-bold text-[#f44708]">₦2,000+</div>
                      <div className="text-sm text-gray-600">Average Cost</div>
      ...
      <section className="py-20 bg-gradient-to-br from-[#2f2f2f] to-black text-white relative overflow-hidden">
        ...
        <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-gray-300 mb-8 max-w-2xl mx-auto">
            Join 50,000+ happy senders who have switched to Prawnbox. Save money, save time, track everything live.
          </p>
