...
interface HandoverQRScreenProps {
  onBack: () => void;
  onScanSuccess?: (code: string) => void;
  handoverCode: string;
  deliveryId: string;
  itemTitle: string;
  userRole?: 'sender' | 'receiver' | 'pal' | 'proxy';
  isGivingItem?: boolean;
}

export function HandoverQRScreen({ 
  onBack, 
  onScanSuccess,
  handoverCode, 
  deliveryId, 
        ...
        <div className="flex items-center space-x-4">
          ...
          <div className="flex-1">
            <h1 className="text-lg font-semibold text-white">
              {isGivingItem ? 'Item Handover' : 'Item Receipt'}
            </h1>
            <p className="text-sm text-gray-400">{getInstructions()}</p>
          </div>
        </div>
      </motion.div>
                ...
                <div className="flex items-start space-x-3">
                  ...
                  <div className="flex-1">
                    <p className="text-blue-200 text-sm leading-relaxed">
                      {isGivingItem 
                        ? "The receiver can scan this code with their camera to verify the handover. Alternatively, they can share their code for you to scan."
                        : "The sender can scan this code with their camera to verify the handover. Alternatively, they can share their code for you to scan."
                      }
                    </p>
                  </div>
                </div>
                    ...
                    <div className="flex items-start space-x-3">
                      ...
                      <div className="flex-1">
                        <p className="text-green-200 text-sm leading-relaxed">
                          {isGivingItem
                            ? "Position the receiver's QR code within the frame to verify and complete the handover."
                            : "Position the sender's QR code within the frame to verify and confirm receipt of the item."
                          }
                        </p>
                      </div>
                    </div>
