...
export function QuickActionsCard({
  ...
  const config =
    ACTION_BUTTON_CONFIGS[
      activeRole.toUpperCase() as keyof typeof ACTION_BUTTON_CONFIGS
    ];
      ...
      >
        <div className=" border-b-0">
          ...
          <div className="grid grid-cols-2 gap-4 mb-8">
            ...
            >
              ...
              <div className="text-left">
                <p className="text-xs font-medium text-teal-700 mb-1 uppercase tracking-wide">
                  Wallet Balance
                </p>
                  ...
                  <button
                    ...
                    className={`w-8 h-8 rounded-lg flex items-center justify-center transition-all ${
                      showEscrowTooltip
                        ...
                        : "bg-white/60 text-primary-dark hover:bg-white hover:text-primary"
                    }`}
                    style={{
                      pointerEvents: "auto",
                      userSelect: "none",
              ...
              {showEscrowTooltip && (
                ...
                >
                  <Card className="border border-gray-200 shadow-2xl rounded-2xl overflow-hidden bg-white">
                    <div className="bg-gradient-to-br from-primary to-primary-dark p-5 relative">
          ...
          <div className="flex items-center justify-between mb-[20px]">
            <h2 className="text-lg font-bold text-prawnbox-primary text-[34px] font-[Plus_Jakarta_Sans] tracking-[-1px]">
        ...
        <div className=" sm:px-6 lg:px-8 mb-4">
          {activeRole === "sender" && (
            <div className="w-full flex flex-row space-x-3">
              ...
              <Button
                className="flex-1 h-16 py-4 text-dark rounded-[13px] flex items-center justify-center space-x-2 active:scale-95 transition-all duration-200 shadow-sm cursor-pointer touch-manipulation"
                style={{
          ...
          {activeRole === "pal" && (
            <div className="w-full flex flex-row space-x-3">
              ...
              <Button
                className="flex-1 h-16 py-4 text-dark rounded-[13px] flex items-center justify-center space-x-2 active:scale-95 transition-all duration-200 shadow-sm"
                style={{
                  backgroundColor: "white",
                  border: "1px solid #f44708",
                  pointerEvents: "auto",
