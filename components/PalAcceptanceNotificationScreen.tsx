    ...
    <div className="min-h-screen bg-white flex flex-col">
      ...
      <div className="flex-1 overflow-y-auto p-6 space-y-6 relative z-10">
        ...
        >
          ...
          <p className="text-gray-500 text-lg">{palData?.name || 'Pal'} is on the way</p>
        </motion.div>
        ...
        >
          <div className="flex items-center justify-between mb-4">
            <div className="flex items-center space-x-3">
              ...
              <h3 className="text-gray-900 font-semibold">{statusInfo.text}</h3>
            </div>
        ...
        >
          <h3 className="text-gray-900 font-semibold mb-4">Your Pal</h3>
          <div className="space-y-4">
            <div className="flex items-center space-x-3">
              ...
              <div>
                <p className="text-gray-900 font-medium">{palData?.name || 'N/A'}</p>
        ...
        >
          <h3 className="text-gray-900 font-semibold mb-4">Delivery Details</h3>
          <div className="space-y-3">
            <div className="flex items-start space-x-3">
              <Package size={20} className="text-green-400 mt-0.5" />
              <div>
                <p className="text-gray-500 text-sm">Item</p>
                <p className="text-gray-900">{deliveryJob?.title || 'N/A'}</p>
              </div>
            </div>
            <div className="flex items-start space-x-3">
              ...
              <div>
                ...
                <p className="text-gray-900">{deliveryJob?.pickupLocation || 'N/A'}</p>
              </div>
            </div>
            <div className="flex items-start space-x-3">
              ...
              <div>
                ...
                <p className="text-gray-900">{deliveryJob?.dropoffLocation || 'N/A'}</p>
              </div>
            </div>
