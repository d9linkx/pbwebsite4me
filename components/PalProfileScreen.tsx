    ...
    <div className="min-h-screen bg-white flex flex-col">
      ...
      >
        <div className="flex items-center space-x-4">
          ...
          <div>
            <h1 className="text-lg font-semibold text-gray-700">Pal Profile</h1>
            <p className="text-sm text-gray-500">Delivery professional</p>
          </div>
        </div>
      </motion.div>
          ...
          <div className="flex items-start space-x-4">
            ...
            <div className="flex-1">
              <div className="flex items-center space-x-2 mb-2">
                <h2 className="text-xl font-bold text-gray-700">{pal.name || 'Pal Name'}</h2>
              ...
              <div className="flex items-center space-x-1 mb-2">
                ...
                <span className="text-gray-500 text-sm">({pal.totalDeliveries || 0} deliveries)</span>
              </div>
        ...
        >
          ...
          <div className="flex items-center space-x-3">
            ...
            <div>
              ...
              <p className="text-gray-500 text-sm">Delivery Vehicle</p>
            </div>
          </div>
        </motion.div>
