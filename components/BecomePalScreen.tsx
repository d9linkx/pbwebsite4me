  ...
  return (
    <div className="min-h-screen bg-linear-to-br from-dark via-darker to-dark flex flex-col">
      ...
      <div className="flex-1 overflow-y-auto p-6 space-y-6 relative z-10">
        {/* Hero Section */}
        <motion.div
          className="bg-linear-to-r from-green-500/20 to-blue-500/20 border border-green-500/30 rounded-2xl p-6"
          initial={{ opacity: 0, y: 20 }}
          animate={{ opacity: 1, y: 0 }}
        >
          <div className="flex items-center space-x-4 mb-4">
            <div className="w-16 h-16 rounded-full bg-linear-to-br from-green-500 to-blue-500 flex items-center justify-center">
          ...
          <div className="flex items-start space-x-3 pt-2">
            ...
            >
              ...
              <span className="text-green-400 font-medium">
                Pal Terms & Conditions
              </span>{" "}
              and understand I&apos;ll be subject to background verification
            </label>
          </div>
        </motion.div>
        ...
        <motion.button
          ...
          className="w-full bg-linear-to-r from-green-500 to-blue-500 hover:from-green-600 hover:to-blue-600 text-white py-4 rounded-xl font-semibold disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center space-x-2"
          whileHover={
            vehicleType && availability && agreedToTerms ? { scale: 1.02 } : {}
          }
          whileTap={
            vehicleType && availability && agreedToTerms ? { scale: 0.98 } : {}
          }
          initial={{ opacity: 0, y: 20 }}
          animate={{ opacity: 1, y: 0 }}
